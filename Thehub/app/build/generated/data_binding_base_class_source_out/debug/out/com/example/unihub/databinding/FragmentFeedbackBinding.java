...
public final class FragmentFeedbackBinding implements ViewBinding {
  ...
  private FragmentFeedbackBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnSubmit,
      @NonNull TextInputEditText etContact, @NonNull TextInputEditText etFeedback,
  ...
  public static FragmentFeedbackBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFeedbackBinding((LinearLayout) rootView, btnSubmit, etContact, etFeedback,
          toolbar);
    }
